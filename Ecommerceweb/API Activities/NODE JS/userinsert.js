...
app.post("/userinsert", function (req, res) {
  ...
  var reg = req.body.values.bIsRegirtered;
  var datecr = req.body.values.dtCreatedOn;
  var dateup = req.body.values.dtUpdatedOn;
  var bdel = req.body.values.bDeleteFlag;
  ...
  con.query(
    ...
    [username, pswd,firstnm,lastname,countrynam,statenam,addr,street,city,pin,phone,website,reg,datecr,dateup,bdel],
